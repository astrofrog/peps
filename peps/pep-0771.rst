...
target system – for example, extras themselves have no equivalent in conda,
yet conda-forge successfully packages thousands of Python projects (with some
...
different package distributions. However, ultimately, default extras provide
additional signal about how package authors would like their package to be
installed for the majority of users, and this should inform repackaging
decisions regardless of the target distribution.
